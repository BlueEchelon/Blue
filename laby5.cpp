...
class Zawodnik{
	...
	public:
		...
		friend void wyswietl(class Zawodnik* tab,int ilosc);
...
void Zawodnik::wyniki(class Zawodnik* tab,int ilosc){
	for(int a=0;a<ilosc;a++){
		...
		class wyscigi{
			public:
				int wys1,wys2,wys3;
				wyscigi(int wys1,int wys2,int wys3):wys1(wys1),wys2(wys2),wys3(wys3)
				{}
		};
		wyscigi w(tab[a].w1,tab[a].w2,tab[a].w3);
		int tablica[3];
		tablica[0]=w.wys1;
		tablica[1]=w.wys2;
		tablica[2]=w.wys3;
...
int main(int argc, char** argv) {
	...
	Zawodnik::Plik *plik = new Zawodnik::Plik;
	string nazwa;
	int n;
